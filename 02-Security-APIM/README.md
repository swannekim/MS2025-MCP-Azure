...
> 이미 APIM에 API가 있다면 이 단계를 건너뜁니다. 없다면 **OpenAPI/URL/리소스**에서 API를 가져오는 방법을 참고하세요. [MS Learn Tutorial: Import and publish your first API](https://learn.microsoft.com/en-us/azure/api-management/import-and-publish). 해당 튜토리얼 예제에서는 [오픈소스 Petstore API](https://github.com/raghavendraprakash/mcpforrestapis)를 사용합니다.
...
## Try it out: VS Code + Copilot Agent 모드
